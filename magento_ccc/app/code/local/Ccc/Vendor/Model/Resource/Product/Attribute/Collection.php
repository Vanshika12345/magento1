...
class Ccc_Vendor_Model_Resource_Product_Attribute_Collection extends Mage_Eav_Model_Resource_Entity_Attribute_Collection {
	...
	protected function _initSelect() {
		// $entityTypeId = (int) Mage::getModel('eav/entity')->setType(Ccc_Vendor_Model_Product::ENTITY)->getTypeId();
		...
		// 	->join(
		// 		array('additional_table' => $this->getTable('vendor/product_eav_attribute')),
		// 		'additional_table.attribute_id = main_table.attribute_id'
		// 	)
		// 	->where('main_table.entity_type_id = ?', $entityTypeId);
		// return $this;
		$this->getSelect()->from(array('main_table' => $this->getResource()->getMainTable()))
			->where('main_table.entity_type_id=?', Mage::getModel('eav/entity')->setType(Ccc_Vendor_Model_Product::ENTITY)->getTypeId())
			->join(
				array('additional_table' => $this->getTable('vendor/product_eav_attribute')),
				'additional_table.attribute_id = main_table.attribute_id'
			);
