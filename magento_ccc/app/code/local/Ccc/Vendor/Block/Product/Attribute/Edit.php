...
class Ccc_Vendor_Block_Product_Attribute_Edit extends Mage_Core_Block_Template {
	...
	public function getSaveUrl() {
		return $this->getUrl('*/*/save', ['attribute_id' => $this->getRequest()->getParam('attribute_id')]);
	}
