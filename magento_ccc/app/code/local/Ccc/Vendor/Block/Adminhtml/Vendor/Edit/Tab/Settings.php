 ...
 */
class Ccc_Vendor_Block_Adminhtml_Vendor_Edit_Tab_Settings extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $entityType = Mage::registry('current_vendor')->getResource()->getEntityType();
