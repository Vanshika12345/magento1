...
class Ccc_Vendor_Block_Adminhtml_Product_Attribute_Set_Main extends Mage_Adminhtml_Block_Template {
    ...
    protected function _construct() {
        $this->setTemplate('vendor/product/attribute/set/main.phtml');
    }

    /**
     * Prepare Global Layout
     *
     * @return Mage_Adminhtml_Block_vendor_Product_Attribute_Set_Main
     */
    ...
    public function getGroupTreeJson() {
        ...
        $groups = Mage::getModel('eav/entity_attribute_group')
            ...
            ->setSortOrder()
            ->load();
        Mage::log($groups, null, 'group.log', true);
        ...
        foreach ($groups as $node) {
            ...
            // ->checkConfigurableProducts()
                ->load();
            // Mage::log($nodeChildren, null, "node.log", true);
    ...
    public function getAttributeTreeJson() {
        ...
        foreach ($attributes as $child) {
            Mage::log($child, null, 'child.log', true);
            $attr = array(
                'text' => $child->getAttributeCode(),
                'id' => $child->getAttributeId(),
                'cls' => 'leaf',
    ...
    protected function _toHtml() {
        Mage::dispatchEvent('adminhtml_vendor_product_attribute_set_main_html_before', array('block' => $this));
