...
class Ccc_Vendor_Adminhtml_Product_SetController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function setGridAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()
                ->createBlock('vendor/adminhtml_product_attribute_set_grid')
                ->toHtml());
    }
    ...
    /**
     * Define in register vendor_product entity type code as entityType
     *
     */
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('vendor/attributes/sets');
    }

    /**
     * Retrieve vendor product entity type id
     *
     * @return int
     */
