...
class Ccc_Vendor_Adminhtml_Product_AttributeController extends Mage_Adminhtml_Controller_Action {
	...
	public function indexAction() {
		$this->_initAction()
			->_addContent($this->getLayout()->createBlock('vendor/adminhtml_product_attribute'))
			->renderLayout();
	}
	...
	protected function _isAllowed() {
		return Mage::getSingleton('admin/session')->isAllowed('vendor/attributes/attributes');
	}
}
