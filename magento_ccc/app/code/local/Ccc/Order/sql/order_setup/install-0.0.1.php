...
$table = $installer->getConnection()->newTable($installer->getTable('order/cart'))
	...
	->addColumn('total',Varien_Db_Ddl_Table::TYPE_DECIMAL,null,[
		'nullable' => false
	],'total')
	->addColumn('discount',Varien_Db_Ddl_Table::TYPE_DECIMAL,null,[
		'nullable' => true
	],'discount')
	...
	->addColumn('shipping_amount',Varien_Db_Ddl_Table::TYPE_DECIMAL,null,[
		'nullable' => false
	],'shipping_amount')
