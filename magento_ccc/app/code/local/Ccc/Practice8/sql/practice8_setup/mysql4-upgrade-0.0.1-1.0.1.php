...
$table = $installer->getConnection()->newTable($installer->getTable('practice8/eav_attribute'))
    ...
    ->addIndex($installer->getIdxName('practice8/eav_attribute',array('used_for_sort_by')),array('used_for_sort_by'))
    ->addIndex($installer->getIdxName('practice8/eav_attribute',array('used_in_product_listing')),array('used_in_product_listing'))
    ->addForeignKey($installer->getFkName('practice8/eav_attribute','attribute_id','eav/attribute','attribute_id'),'attribute_id',$installer->getTable('eav/attribute'),'attribute_id',Varien_Db_Ddl_Table::ACTION_CASCADE,Varien_Db_Ddl_Table::ACTION_CASCADE);
$query = "ALTER TABLE `practice8_varchar` ADD UNIQUE(`store_id`,`attribute_id`,`entity_id`)";
$installer->getConnection()->query($query);
$installer->getConnection()->createTable($table);

$setup = new Mage_Eav_Model_Entity_Setup('core_setup');
$setup->addAttribute(Ccc_Practice8_Model_Resource_Practice8::ENTITY,'fname',[

	'global' => Ccc_Practice8_Model_Resource_Eav_Attribute::SCOPE_STORE,
	'filterable' => 0,
	'searchable' => 0,
	'visible' => 1,
	'visible_on_front' => 0,
